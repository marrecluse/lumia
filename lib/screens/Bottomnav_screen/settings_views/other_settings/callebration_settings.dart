...
import 'package:velocity_x/velocity_x.dart';
 ...
 class CallebrationSetting extends StatefulWidget {
  const CallebrationSetting({super.key});

  @override
  State<CallebrationSetting> createState() => _CallebrationSettingState();
}

class _CallebrationSettingState extends State<CallebrationSetting> {
  @override
        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              height:
                  _isContainerVisible ? 170 : 100, // Adjust the height as needed
              child: Center(
                child: Padding(
