...
class ChargeCurrent extends StatefulWidget {
  const ChargeCurrent({super.key});

  @override
  State<ChargeCurrent> createState() => _ChargeCurrentState();
}

class _ChargeCurrentState extends State<ChargeCurrent> {
